...
export async function deployContractsFixture() {
  ...
  expect(ProtocolFactory.bytecode.length / 2).lessThan(maxContractSize);
  const Protocol = await ProtocolFactory.deploy();
  const protocol = Protocol__factory.connect(await Protocol.getAddress(), provider);
  ...
  const iBGT8VaultContract = await InfraredBribeVaultFactory.deploy(
    ...
    await iBGT8.getAddress(), "Wand piBGT8", "piBGT8"
  );
  ...
  const iBGT28VaultContract = await InfraredBribeVaultFactory.deploy(
    ...
    await iBGT28.getAddress(), "Wand piBGT28", "piBGT28"
  );
  ...
  const yeetBribeVaultContract = await ERC4626BribeVaultFactory.deploy(
    ...
    await yeetLp.getAddress(), "Wand pYeetLP", "pYeetLP"
  );
  ...
  const yeetBribeVaultContract8 = await ERC4626BribeVaultFactory.deploy(
    ...
    await yeetLp8.getAddress(), "Wand pYeetLP 8", "pYeetLP8"
  );
